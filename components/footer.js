...
export function Footer() {
    return (
        <footer className="grid w-full bg-gray-100">
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 px-2 py-3 text-gray-500 grid-flow-row-dense">
                <div className="flex justify-center lg:justify-start space-x-10 whitespace-nowrap lg:ml-5 tracking-tight text-sm">
                ...
                <div className="flex justify-center items-center lg:justify-end space-x-5 lg:space-x-10 whitespace-nowrap lg:mr-5 tracking-tight text-sm">
